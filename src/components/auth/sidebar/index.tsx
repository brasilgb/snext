                ...
                <ul className="">
                    <li className="mt-2">
                        <Link
                            ...
                            className={`flex items-center justify-start gap-x-4 hover:bg-white hover:text-secundary-blue transition-all duration-300 ${pathname === '/'
                    ...
                    <li className="mt-2">
                        <Link
                            onClick={() => setNavDropdown(false)}
                            className={`flex items-center justify-start gap-x-4 hover:bg-white hover:text-secundary-blue transition-all duration-300 ${pathname === '/clientes' ||
                    ...
                    <li className="mt-2">
                        <Link
                            onClick={() => setNavDropdown(false)}
                            className={`flex items-center justify-start gap-x-4 hover:bg-white hover:text-secundary-blue transition-all duration-300 ${pathname === '/ordens' ||
                    ...
                    <li className="mt-2">
                        <Link
                            onClick={() => setNavDropdown(false)}
                            className={`flex items-center justify-start gap-x-4 hover:bg-white hover:text-secundary-blue transition-all duration-300 ${pathname === '/produtos' ||
                    ...
                    <li className="mt-2">
                        <Link
                            onClick={() => setNavDropdown(false)}
                            className={`flex items-center justify-start gap-x-4 hover:bg-white hover:text-secundary-blue transition-all duration-300 ${pathname === '/agendas' ||
                    ...
                    <li className="mt-2">
                        <Link
                            onClick={() => setNavDropdown(false)}
                            className={`flex items-center justify-start gap-x-4 hover:bg-white hover:text-secundary-blue transition-all duration-300 ${pathname === '/mensagens' ||
                    ...
                    >
                        ...
                        >
                            <li className="mt-2">
                                <Link
                                    onClick={() => setNavDropdown(false)}
                                    className={`flex items-center justify-start gap-x-4 hover:bg-white hover:text-secundary-blue transition-all duration-300 ${open ? 'p-2' : 'px-0 py-2'
                                        } rounded`}
                                    href={'/empresa'}
                                    title="Empresa"
                                >
                    ...
                    <li className="mt-2">
                        <Link
                            onClick={() => setNavDropdown(false)}
                            className={`flex items-center justify-start gap-x-4 hover:bg-white hover:text-secundary-blue transition-all duration-300 ${pathname === '/usuarios' ||
